function shell() {
  ...
  const pages = { dashboard: 'Dashboard', chat: 'Chat', notebooks: 'MBM Book', doubts: 'Doubts', attendance: 'Attendance', copycheck: 'Copy Check', fileshare: 'Shared Files', tests: 'Tests', settings: 'Settings', admin: 'Admin' };
    ...
    <nav class="sidebar${sidebarCompactClass}" id="sidebar" ${sidebarStyle}>
      ...
      <div class="sidebar-inner">
        ...
        <div class="sidebar-nav">
          ...
          <a href="#tests" data-page="tests" class="${state.page==='tests'?'active':''}">
