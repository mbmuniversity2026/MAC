function shell() {
  ...
  const pages = { dashboard: 'Dashboard', chat: 'Chat', mbmbook: 'MBM Book', doubts: 'Doubts', fileshare: 'Shared Files', settings: 'Settings', admin: 'Admin' };
    ...
    <nav class="sidebar${sidebarCompactClass}" id="sidebar" ${sidebarStyle}>
      ...
      <div class="sidebar-inner">
        ...
        <div class="sidebar-nav">
          ...
          <a href="#mbmbook" data-page="mbmbook" class="${state.page==='mbmbook'?'active':''}">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 3v18"/><path d="M13 7h5"/><path d="M13 11h5"/><path d="M13 15h5"/></svg>
            <span>MBM Book</span>
          </a>
